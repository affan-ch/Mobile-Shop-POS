    ...
    <div class="toolbar py-5 py-lg-5" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-xxl d-flex flex-stack flex-wrap">
            ...
            <div class="page-title d-flex flex-column me-3">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder my-1 fs-3">Admins</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-dot fw-bold text-gray-600 fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-gray-600">Admins</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
            ...
            <div class="row gy-lg-5 g-xl-10">
                <div class="col-12">
                    ...
                    <div class="d-flex flex-wrap flex-stack pt-10 pb-8">
                        <!--begin::Heading-->
                        <h1 class="fw-bolder my-2">Admins
                        </h1>
                        <!--end::Heading-->
                    </div>
                    <!--end::Toolbar-->
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content shadow-none">
                ...
                <div class="modal-body">
                    ...
                    <!--begin::Form-->
                    <form class="form" method="post" action="{{ url('super-admin/admin/add') }}"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content shadow-none">
                ...
                <div class="modal-body">
                    ...
                    <!--begin::Form-->
                    <form class="form" method="post" action="{{ url('super-admin/admin/update-password') }}"
                        enctype="multipart/form-data" id="form_insert">
                        @csrf
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content shadow-none">
                ...
                <div class="modal-body">
                    ...
                    <!--begin::Form-->
                    <form class="form" method="post" action="{{ url('super-admin/admin/edit') }}"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-none">
                ...
                <div class="modal-body">
                    ...
                    <!--begin::Form-->
                    <form class="form" method="post" action="{{ url('super-admin/admin/delete') }}"
